...
<td width='150'><b><a href='/links.html'>Витрина ссылок</a> | <img src='/template/apimages/ok.png' width='15' height='15' align='absmiddle'>Витрина баннеров</b></td>



<div id='adr'><br />Из списка ниже, можете выбрать сайт где вы сможете разместить ваш баннер.
</div>
...
{ 
echo("<div id='adr'>Рекламодатель! Нужных сайтов для рекламы пока нету!</div>"); 
} 
...
$pars1=mysql_fetch_array(mysql_query("SELECT `pr`,`cu`,`yahoo`,`lipok`,`lipos` FROM `pars` WHERE `uid`='$row[1]'"));
$pars2=mysql_fetch_array(mysql_query("SELECT `w`,`d` FROM `tables` WHERE `id`='".$row[1]."'"));
...
<td width='30%'>Адрес: <a href='$query_arr1[1]' target='_blank'>$url</a></br>Размер: $pars2[0]x$pars2[1]</br>ТИЦ: $pars1[1]</br>PR: $pars1[0]/10</td>
