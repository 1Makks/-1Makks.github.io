...
$query_array=mysql_query("SELECT `id`,`href`,`pos`,`text` FROM `banners` ORDER BY `pos` DESC"); 

echo("<a href='/".$config['admin'].".php?page=banners&sub=add'><img src='/images/icon/banner.png' width='15' height='15' align='absmiddle'>Добавить баннер</a><br><br>
...
echo("<td>$row[1]</td><td><a href='$query_arr1[1]' target='_blank'>$query_arr1[1]</a></td>

<td>$query_arr1[0]</td><td><a href='/".$config['admin'].".php?page=banners&sub=pos&id=$row[0]'><img src='template/apimages/edit.png' align='absmiddle'></a> <a href='/".$config['admin'].".php?page=banners&sub=on'><img src='/template/apimages/refresh.png' width='15' height='15' align='absmiddle'></a> <a href='/".$config['admin'].".php?page=banners&sub=delete&id=$row[0]'><img src='template/apimages/delete.png' align='absmiddle'></a> </td></tr>"); 
} 
echo("</table>
