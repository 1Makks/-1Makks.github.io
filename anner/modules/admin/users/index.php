...
<table class='ap_list_table'>
	<tr>
		...
		<td class='ap_list_table_td'>Email</td>
		<td class='ap_list_table_td'>ICQ</td>
		<td class='ap_list_table_td'>IP</td>
...
$site_arr=mysql_query("SELECT `id`,`login`,`email`,`icq`,`ip`,`wmr`,`balance` FROM `users` ORDER BY `id` DESC LIMIT $start,$perpage");
